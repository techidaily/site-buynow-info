...
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/img_2040-1.JPG
---

## Be Part of NASA's Space Tech Revolution - Take On Our 2024 Challenge Now!
...
Registration for the 2024 NASA International Space Apps Challenge is now open. It's your chance to build space-related visualizations, apps, and other projects for the "largest annual global hackathon."
 ...
 For example, in 2023, to address the _Explore Open Science Together_ theme, teams' tasks ranged from creating customized itineraries for future space travelers and producing educational material about the many different objects in our solar system, to creating visual tools laying out the complete path of water across Earth and using publicly available imaging spectroscopy data to map biodiversity hotspots. The theme for 2024 is _The Sun Touches Everything_, in celebration of the sun's influence on our planet and the solar system as a whole.
...
* Local Impact
 ...
 To participate, you must first [create an account](https://www.spaceappschallenge.org/resources/-faq/) via the Space Apps website, and doing so is straightforward—simply insert your name, email address, area of residence, and, if you wish, an avatar. Then, you can register for the hackathon, and choose an event to attend. If there aren't any events near you, don't fret—you can join one of the many virtual events.

 You can start finding and forming teams from August 22, 2024, before joining Space Apps Connect in late September, 2024\. Entrants must submit their projects by midnight local time on October 6, 2024, which marks the end of the two-day hackathon event.

 Source: [Space Apps Challenge](https://www.spaceappschallenge.org/), [Space Apps FAQ](https://www.spaceappschallenge.org/resources/-faq/)
