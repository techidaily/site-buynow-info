...
##  A More Powerful Steam Deck
 ...
 Despite receiving a revision with the [introduction of the Steam Deck OLED](https://youtube-blog.techidaily.com/024-approved-clip-weaver-workshop/) in late 2023, the Deck still packs almost identical hardware to the model that debuted in February 2022\. Under the hood is a custom AMD APU built on the same RDNA 2 and Zen 2 architecture found in the Xbox Series consoles and Sony’s PlayStation 5.
...
##  Potentially Good for the Windows Handheld Experience
 ...
 Using a mouse with a thumbstick isn’t fun, and tapping on-screen elements with your fingers leaves grease all over the display. Furthermore, the mish-mash of third-party utilities you need to use to manage the device can be miserable. To quote [Sydney’s ROG Ally review for How-To Geek](https://win-amazing.techidaily.com/fast-track-access-your-guide-to-downloading-hp-stream-driver-software/): “things are more than a little rough around the edges when you aren't actually playing a game.”
...
##  It Could Be a Homebrew Monster
 ...
 This is what makes it possible to [run emulators like RetroArch on your Xbox](https://screen-video-capture.techidaily.com/updated-in-2024-leveraging-filters-masks-and-effects-to-elevate-conference-calls/). This mode has existed since the Xbox One era, and [Microsoft confirmed in 2022](https://www.techradar.com/news/xbox-dev-mode-isnt-going-anywhere-despite-emulation-concerns#:~:text=A%20Microsoft%20representative%20has%20said,game%20development%20community%20on%20Xbox.%22) that it has no intentions of removing the mode any time soon. This makes the inclusion of Developer Mode on a portable Xbox all the more likely.
...
##  Combining Native, Remote, and Cloud Play
 ...
 Arguably the most enticing method would be native play, but remote play from a Series X or S over Wi-Fi or the ability to access Xbox Cloud Gaming titles are solid options too. Microsoft has stated that it wants you to be able to play on any screen (hence Game Pass integration with [smart TVs](https://www.xbox.com/en-US/apps/xbox-app-for-tv)), and a portable certainly fits into this strategy.
...
---
 ...
 Though speculation is rife, we’ll have to wait and see what Microsoft announces in the future. The company already [promised](https://news.xbox.com/en-us/podcast/phil-spencer-sarah-bond-and-matt-booty-share-updates-on-the-xbox-business/) “some exciting stuff coming out in hardware that we're going to share this holiday.”

 If you can’t wait until then take a look at [our best handheld gaming PC round-up](https://hardware-tips.techidaily.com/the-ultimate-guide-to-tech-devices-by-toms-authority-in-hardware/) and [comparison between the Deck, Alley, and Legion Go](https://screen-capture.techidaily.com/updated-in-2024-discover-the-10-leading-no-cost-webcalls-for-businesses/).
